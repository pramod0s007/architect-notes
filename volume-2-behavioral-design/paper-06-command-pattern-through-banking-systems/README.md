...
[Command Pattern Through Banking Systems](https://medium.com/@replytopramods.aws/command-pattern-through-banking-systems-a50491b11df9)
...
|---------|--------|--------------|
| [`command/banking-example/`](./banking-example/) | Finance | Deposit, Withdraw, Transfer with undo stack |
| [`command/document-editor/`](./document-editor/) | Productivity | Insert, Delete, Format text with full undo/redo |
| [`command/job-scheduler/`](./job-scheduler/) | Infrastructure | Email, Report, DataSync jobs — scheduled, deferred, retriable |
